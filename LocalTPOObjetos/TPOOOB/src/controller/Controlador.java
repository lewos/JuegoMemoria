...
public class Controlador {
	...
	/**
	 * asumo que c/usuario tiene un nivel en cada juego, en el que se quedo o si
	 * es un nuevo ususario en el nivel 1 de c/juego
	 * 
	 * No me queda claro que tengo que devolver, pq deveria dar un nivel de un
	 * juego de usuarioActual pero el MVC no me deja darle objetos del modelo a
	 * la vista
	 */
	public List<String> cargarNivel(String nombreJuego) {
		...
		/*
		 * y ahora paso el path de las piezas ? y la cantidad las tengo que
		 * pasar al view?
		 */
	...
	public boolean validarParPiezas(String nomPiezaSel1, String nomPiezaSel2, String nombreJuego) {
		...
		if (nomPiezaSel1.equals(nomPiezaSel2))
			// validarPar tendria que aumentar parCorrectos// pero no se si un
			// cast es mvc
